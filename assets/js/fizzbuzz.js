...
for (var i = number1; i <=number2 ; i++) {
    if (i % 5 == 0)  document.write("<h3 style='background-color:blue;color:white;text-align:center;'>"+i+"FizzBuzz</h3>");
    else if (i % 2 == 0) document.write("<h3 style='background-color:red;color:white;text-align:center;'>"+i+"Fizz</h3>");
